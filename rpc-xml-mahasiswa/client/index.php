	...
	<div class="container">
		<fieldset>
					...
					<div class="control-group">
						...
						<div class="controls">
							<textarea name="alamat" class="input-xlarge"
								placeholder="Alamat"><?= isset($r['alamat']) ? $r['alamat'] : '' ?></textarea>
						</div>
					</div>
					<div class="control-group">
						<div class="controls">
					...
					foreach ($data_array as $r) {
						?>
							<tr>
								...
								<td>
									<a href="?page=ubah&nim=<?= $r['nim'] ?>" role="button" class="btn btn-success"><i
											class="icon-pencil"></i></a>
									<a href="proses.php?aksi=hapus&nim=<?= $r['nim'] ?>" role="button" class="btn btn-danger"
			...
			<? } else {
				?>
						<legend>Home</legend>
						Aplikasi sederhana ini menggunakan RPC (Remote Procedure Call) dengan format data XML (Extensible Markup
						Language).
					</fieldset>
				</div>
	<? }
