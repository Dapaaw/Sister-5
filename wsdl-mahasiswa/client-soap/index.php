	...
	<div class="container">
		<fieldset>
					...
					<div class="span8 alert alert-info">
						<form class="form-horizontal" name="form1" method="POST" action="proses.php" novalidate>
							...
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" name="no_hp" class="input-medium" placeholder="No HP" required>
								</div>
							</div>
					...
					foreach ($data_array as $r) {
						...
						<tr>
							...
							<td><a href="proses.php?aksi=hapus&nim=<?= $r->nim ?>" class="btn btn-danger"
									onclick="return confirm('Yakin ingin hapus data ini?')"><i class="icon-remove"></i></a></td>
						</tr>
						<?php $no++;
					}
			...
			<?php } else { ?>
				<legend>Home</legend>
				<p>
					Aplikasi ini menggunakan <b>WSDL (Web Services Description Language)</b> berbasis SOAP dan XML untuk
					pertukaran data antara server dan client.
					Server menggunakan library <b>NuSOAP</b> dan client menggunakan <b>SOAP Client</b> bawaan PHP.
				</p>
