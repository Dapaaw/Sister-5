...
<head>
	<meta charset="utf-8">
	<title>Data Mahasiswa WSDL</title>
...
<body>
	...
	<div class="container">
		<fieldset>
					...
					<div class="span8 alert alert-info">
						<form class="form-horizontal" name="form1" method="POST" action="proses.php" novalidate>
							...
							<div class="control-group">
								...
								<div class="controls">
									<input type="email" name="email" class="input-medium" placeholder="Email Mahasiswa"
										required>
								</div>
							</div>
			...
			<?php } else { ?>
						<legend>Home</legend>
						Aplikasi ini menggunakan <strong>WSDL (Web Services Description Language)</strong> berbasis
						<strong>NuSOAP</strong> dengan format data XML.
			<?php } ?>
